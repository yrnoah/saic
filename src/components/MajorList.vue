<template>
	<div>
		...
		<div class="major-detail">
			<div class="icon-label-product ani" swiper-animate-effect="flipInY" swiper-animate-duration="0.5s" swiper-animate-delay="1s"></div>
			<div>
		...
		<div class="major-detail">
			<div class="icon-label-dollar ani" swiper-animate-effect="flipInX" swiper-animate-duration="0.5s" swiper-animate-delay="1.7s"></div>
			<div>
		...
		<div class="major-detail">
			<div class="icon-label-law ani" swiper-animate-effect="flipInY" swiper-animate-duration="0.5s" swiper-animate-delay="2.3s"></div>
			<div>
