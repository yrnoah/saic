<template>
    ...
    <div class="report-content">
      <div class="cover-year"><div class="report-year"></div></div>
      <div class="cover-title"><div class="report-title"></div></div>
...
<style scoped>
  ...
  .report-year {
    background: url(../../images/elements/report-year.png) no-repeat;
  ...
  .report-title {
    background: url(../../images/elements/report-title.png) no-repeat;
    background-size: contain;
    margin: 0 auto;
    position: relative;
    top: 24px;
