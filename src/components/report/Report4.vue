...
<style scoped>
  ...
  .report4-title {
    background: url(../../../static/report4-title.png) no-repeat;
  ...
  .report4-content {
    background: url(../../../static/report4-content.png) no-repeat;
    background-size: contain;
    margin: 0 auto;
    position: relative;
    top: 24px;
  ...
  .rotateEarth {
    animation: rotate-page4 40.0s infinite linear;
  }
  .car-position {
    position: absolute;
    bottom: 70px;
