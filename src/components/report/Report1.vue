<template>
    ...
    <div class="report-content">
      <div class="cover-year"><div class="report1-title"></div></div>
      <div class="cover-title"><div class="report1-content"></div></div>
...
<style scoped>
  ...
  .report1-title {
    background: url(../../images/elements/report1-title.png) no-repeat;
  ...
  .report1-content {
    background: url(../../images/elements/report1-content.png) no-repeat;
    background-size: contain;
    margin: 0 auto;
    position: relative;
    top: 24px;
