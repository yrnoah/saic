<template>
    ...
    <div class="hide">
      ...
      <img src="../../static/home-slogan.png" class="preloadImg" >
      <img src="../../static/home-bottom.png" class="preloadImg" >
      ...
      <img src="../../static/home-bgs.png" class="preloadImg" >
      <img src="../../static/home-title.png" class="preloadImg" >
      ...
      <img src="../../static/home-logo.png" class="preloadImg" >
      <img src="../../static/home-windmill-leaves.png" class="preloadImg" >
      <img src="../../static/home-windmill-range.png" class="preloadImg" >
      <img src="../../static/home-windmill1.png" class="preloadImg" >
      <img src="../../static/provide-building.png" class="preloadImg" >
      <img src="../../static/provide-car.png" class="preloadImg" >
      <img src="../../static/provide.png" class="preloadImg" >
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //     imgItem.push(img);
      //     img.onload = () => {
      //       const tmpCount = this.loadCount + 1;
      //       this.$set('loadCount', tmpCount);
      //       console.log(img, this.loadCount, imgItem.length);
      //       if (this.loadCount === imgItem.length) this.goHome();
      //       // this.count = Math.floor((this.loadCount / imgList.length));
      //     };
      //   }
      // },
    },
